    ...
    return (
        <div className={cn(styles.cardPreview, { [styles.squeezed]: isSettingsOpen, [styles.showHelp]: !visitCard })}>
            {isCardEdited ? (
                ...
                <p>Click on the settings button (upper right corner) to start creating !</p>
            )}
            {isCardEdited && (
                <div className={cn(styles.card, styles.cardBack)} style={computedStyle}>
                    ...
                    <div className={styles.cardData}>
                        ...
                        <p className={styles.contact}>
                            {phone && <span style={fontStyles?.phone}><Phone fontSize="inherit" /> {phone}</span>}<br />
                            {email && <span style={fontStyles?.email}><Email fontSize="inherit" /> {email}</span>}<br />
                            {twitter && <span style={fontStyles?.twitter}><Twitter fontSize="inherit" />{twitter}</span>}
                        </p>
                    </div>
                </div>)}
        </div>
