      ...
      <div>
        ...
        <ColorPicker
          ...
          onChange={(color) =>
            setFontStyles({
              ...fontStyles,
              position: { ...fontStyles?.position, color },
            })
          }
        />
        <input
      ...
      <div>
        ...
        <ColorPicker
          ...
          onChange={(color) =>
            setFontStyles({
              ...fontStyles,
              company: { ...fontStyles?.company, color },
            })
          }
        />
        <input
      ...
      <div>
        ...
        <ColorPicker
          ...
          onChange={(color) =>
            setFontStyles({
              ...fontStyles,
              twitter: { ...fontStyles?.twitter, color },
            })
          }
        />
        <input
